  ...
  return session?.user ? (
    <>
      <form className="text-center w-full" onSubmit={handleSubmit}>
        ...
        <label htmlFor="issueOpenContent" className="font-semibold leading-none text-gray-300">Issue Open Content</label>
        <input
          type="text"
        ...
        >
          {showPreview["issueOpenContent"] ? "Hide Preview" : "Show Preview"}
        </button>
        ...
        <br />
          ...
          <div className="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
        <label htmlFor="issueCloseContent" className="font-semibold leading-none text-gray-300">Issue Close Content</label>
        <input
          type="text"
        ...
        <button
          ...
          className="text-blue-500 hover:underline focus:outline-none ml-2"
        >
          {showPreview["issueCloseContent"] ? "Hide Preview" : "Show Preview"}
        </button>
        ...
        <br />
        <div className="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
        <label htmlFor="pullRequestOpenContent" className="font-semibold leading-none text-gray-300">Pull Request Open Content</label>
        <input
          type="text"
        ...
        <button
          ...
          className="text-blue-500 hover:underline focus:outline-none ml-2"
        >
          {showPreview["pullRequestOpenContent"] ? "Hide Preview" : "Show Preview"}
        </button>
        ...
        <div className="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
        <label htmlFor="pullRequestCloseContent" className="font-semibold leading-none text-gray-300">Pull Request Close Content</label>
        <input
          type="text"
        ...
        <button
          ...
          className="text-blue-500 hover:underline focus:outline-none ml-2"
        >
          {showPreview["pullRequestCloseContent"] ? "Hide Preview" : "Show Preview"}
        </button>
